const loadProducts = () => {
  ...
  // const url = `https://fakestoreapi.com/products/${inputText}`;
  // fetch(url)
  //   .then(res => res.json())
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <div class="single-product">
      ...
      <h3 class="fs-5 pt-2">${product.title.slice(0, 20)}</h3>
...
const showDetails = product => {
  const displayDetails = document.getElementById('show-details');

  displayDetails.innerHTML = `
<div class="container px-4">
  <div class="row gx-5">
    <div class="col">
     <div class="p-3 border bg-light"><img class="img-fluid h-25" src=${product.image}>
    </div>
    <div class="col">
      <div class="p-3 border bg-light">
      <h5 class="">${product.title.slice(0, 20)}</h5>
...
//   displayDetails.innerHTML = `
//   <div class=" ">
//  <div> <img class="img-fluid h-25" src=${product.image}></div>
//   <div class="card-body">
//     <h5 class="card-title">${product.title.slice(0, 20)}</h5>
//     <p class="card-text fs-6">Description: ${product.description.slice(0, 50)}.</p>
//     <h2 class="fs-5">Price: $ ${product.price}</h2>
//     <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-success">add to cart</button>
